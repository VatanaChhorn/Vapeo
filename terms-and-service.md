...
- **iCloud Synchronization**: Syncing your data across your personal Apple devices
...
### 4.1 iCloud Integration
- Your data is stored in your private iCloud container
- You are responsible for maintaining the security of your Apple ID and iCloud account
- We cannot access your personal data stored in your iCloud container
...
### 5.2 Acceptable Use
You agree to use the App only for its intended purpose of tracking and reducing vaping habits.
...
- Promote vaping or tobacco use through the App
...
### 11.1 Apple Services Integration
- The App integrates with Apple's iCloud and CloudKit services
...
You agree to indemnify, defend, and hold harmless us, our affiliates, officers, directors, employees, and agents from and against any claims, damages, losses, costs, and expenses (including reasonable attorneys' fees) arising from or related to your use of the App or violation of these Terms.

## 15. Termination

### 15.1 Termination by You
- You may stop using the App at any time
- You can delete your data through the App's reset function
...
- For material changes, we may provide additional notice via email (if available)
...
**Note:** These Terms of Service are designed to protect both users and the developer while ensuring a fair and transparent relationship. We encourage users to read both this document and our Privacy Policy to understand their rights and responsibilities.

**Thank you for choosing Vapeo: Quit Vaping as your partner in your journey to a vape-free life.** 
