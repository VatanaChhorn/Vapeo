...
- **Personal Identity**: We do not collect your name, email address, phone number, or other personally identifiable information
...
- **Private Cloud Storage**: Data is stored in your personal, private iCloud storage - we cannot access your data
- **App Preferences**: Settings and preferences are stored locally using iOS secure storage

### Security Measures
- Data is encrypted using Apple's CloudKit encryption both in transit and at rest
- Your data remains in your private iCloud container - we have no access to it
- CloudKit uses end-to-end encryption for your personal information
- App follows iOS and CloudKit security best practices for data protection
...
### Your Control
- You can delete all your data at any time through the app settings
- You can export your data (future feature)
- You control what information you share with the app

## Your Rights and Choices

### Data Access and Control
- **View Your Data**: All your data is accessible within the app across all your devices
- **Delete Your Data**: Use the "Reset All Data" option in settings to permanently delete all stored information from all your devices
- **Data Portability**: Your data remains in your private iCloud storage and under your control
...
**Note:** This privacy policy reflects our commitment to transparency and user privacy. We believe in putting users in control of their data while providing helpful tools for quitting vaping.
